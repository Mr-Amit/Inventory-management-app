...
public class scanningwhenyes extends AppCompatActivity {
    ...
    protected  void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.no_palletdrop);
        ...
        palletEdit = findViewById(R.id.palletno);

        // EDIT HERE ______________________________________________
        // palletEdit.setText("1306006971");
        pall=palletEdit. getText(). toString();
...
//        });
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pall.equals("") || deli.equals("Select") || cno.equals("")) {
